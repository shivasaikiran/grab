...
const BeautycategoryForm = () => {
  ...
  const fetchBanners = async () => {
    try {
      const bannersCollectionRef = collection(db, 'beautybanner');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        ...
        const bannerDocRef = doc(db, 'beautybanner', bannerEditId);
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'beautybanner', id));
  ...
  const fetchDeals = async () => {
    const dealsCollectionRef = collection(db, 'beautyoffers');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        const dealDocRef = doc(db, 'beautyoffers', editId);
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'beautyoffers', id));
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'beautyblog', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'beautyblog');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'beautyblog', id));
...
export default BeautycategoryForm;
