...
const ElectronicsForm = () => {
  ...
  const fetchAds = async () => {
    try {
      const adsSnapshot = await getDocs(collection(db, 'categories', 'electronics', 'ads'));
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db, 'categories', 'electronics', 'blogs');
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'categories', 'electronics', 'blogs', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'categories', 'electronics', 'blogs');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'electronics', 'blogs', id));
  ...
  const handleAdSubmit = async (e) => {
    ...
    try {
      ...
      if (adEditId) {
        const adDocRef = doc(db, 'categories', 'electronics', 'ads', adEditId);
  ...
  const handleAdDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'electronics', 'ads', id));
  ...
  const fetchItems = async () => {
    try {
      let itemsQuery = collection(db, 'categories', 'electronics', 'items');
  ...
  const fetchBanners = async () => {
    try {
      const bannersSnapshot = await getDocs(collection(db, 'electronicsbanners'));
  ...
  const handleItemSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const itemDocRef = doc(db, 'categories', 'electronics', 'items', editId);
        await updateDoc(itemDocRef, { discount, description, name, discounttext, imageUrl,link });
        toast.success('Item updated successfully!');
      } else {
        const itemsCollectionRef = collection(db, 'categories', 'electronics', 'items');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        const bannerDocRef = doc(db, 'electronicsbanners', bannerEditId);
        await updateDoc(bannerDocRef, {imageUrl: bannerImageUrl });
        toast.success('Banner updated successfully!');
      } else {
        const bannersCollectionRef = collection(db, 'electronicsbanners');
  ...
  const handleItemDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'electronics', 'items', id));
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'electronicsbanners', id));
