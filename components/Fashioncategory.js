...
const FashioncategoryForm = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db,'fashionblog');
  ...
  const fetchBanners = async () => {
    try {
      const bannersCollectionRef = collection(db, 'fashionbanner');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        ...
        const bannerDocRef = doc(db, 'fashionbanner', bannerEditId);
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'fashionbanner', id));
  ...
  const fetchDeals = async () => {
    const dealsCollectionRef = collection(db, 'fashionoffers');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        const dealDocRef = doc(db, 'fashionoffers', editId);
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'fashionoffers', id));
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'fashionblog', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'fashionblog');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'fashionblog', id));
...
export default FashioncategoryForm;
