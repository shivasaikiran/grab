...
const FootwareForm = () => {
  ...
  const fetchAds = async () => {
    try {
      const adsSnapshot = await getDocs(collection(db, 'categories', 'footware', 'ads'));
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db, 'categories', 'footware', 'blogs');
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'categories', 'footware', 'blogs', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'categories', 'footware', 'blogs');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'footware', 'blogs', id));
  ...
  const handleAdSubmit = async (e) => {
    ...
    try {
      ...
      if (adEditId) {
        const adDocRef = doc(db, 'categories', 'footware', 'ads', adEditId);
        await updateDoc(adDocRef, { imageUrl: adImageUrl });
        toast.success('Ad updated successfully!');
      } else {
        const adsCollectionRef = collection(db, 'categories', 'footware', 'ads');
  ...
  const handleAdDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'footware', 'ads', id));
  ...
  const fetchItems = async () => {
    try {
      let itemsQuery = collection(db, 'categories', 'footware', 'items');
  ...
  const fetchBanners = async () => {
    try {
      const bannersSnapshot = await getDocs(collection(db, 'footwarebanners'));
  ...
  const handleItemSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const itemDocRef = doc(db, 'categories', 'footware', 'items', editId);
        await updateDoc(itemDocRef, { discount, description, name, discounttext, imageUrl,link });
        toast.success('Item updated successfully!');
      } else {
        const itemsCollectionRef = collection(db, 'categories', 'footware', 'items');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        const bannerDocRef = doc(db, 'footwarebanners', bannerEditId);
        await updateDoc(bannerDocRef, {imageUrl: bannerImageUrl });
        toast.success('Banner updated successfully!');
      } else {
        const bannersCollectionRef = collection(db, 'footwarebanners');
  ...
  const handleItemDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'footware', 'items', id));
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'footwarebanners', id));
