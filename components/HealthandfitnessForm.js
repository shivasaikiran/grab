...
const HealthandfitnessForm = () => {
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'categories', 'healthandfitness', 'blogs', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'categories', 'healthandfitness', 'blogs');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'healthandfitness', 'blogs', id));
  ...
  const handleAdSubmit = async (e) => {
    ...
    try {
      ...
      if (adEditId) {
        const adDocRef = doc(db, 'categories', 'healthandfitness', 'ads', adEditId);
        await updateDoc(adDocRef, { imageUrl: adImageUrl });
        toast.success('Ad updated successfully!');
      } else {
        const adsCollectionRef = collection(db, 'categories', 'healthandfitness', 'ads');
  ...
  const handleAdDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'healthandfitness', 'ads', id));
  ...
  const fetchItems = async () => {
    try {
      let itemsQuery = collection(db, 'categories', 'healthandfitness', 'items');
  ...
  const fetchBanners = async () => {
    try {
      const bannersSnapshot = await getDocs(collection(db, 'healthandfitnessbanners'));
  ...
  const handleItemSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const itemDocRef = doc(db, 'categories', 'healthandfitness', 'items', editId);
        await updateDoc(itemDocRef, { discount, description, name, discounttext, imageUrl,link });
        toast.success('Item updated successfully!');
      } else {
        const itemsCollectionRef = collection(db, 'categories', 'healthandfitness', 'items');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        const bannerDocRef = doc(db, 'healthandfitnessbanners', bannerEditId);
        await updateDoc(bannerDocRef, {imageUrl: bannerImageUrl });
        toast.success('Banner updated successfully!');
      } else {
        const bannersCollectionRef = collection(db, 'healthandfitnessbanners');
  ...
  const handleItemDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'healthandfitness', 'items', id));
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'healthandfitnessbanners', id));
...
export default HealthandfitnessForm;
