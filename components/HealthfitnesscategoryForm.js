...
const HealthfitnesscategoryForm = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db,'healthfitnessblog');
  ...
  const fetchBanners = async () => {
    try {
      const bannersCollectionRef = collection(db, 'healthfitnessbanner');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        ...
        const bannerDocRef = doc(db, 'healthfitnessbanner', bannerEditId);
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'healthfitnessbanner', id));
  ...
  const fetchDeals = async () => {
    const dealsCollectionRef = collection(db, 'healthfitnessoffers');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        const dealDocRef = doc(db, 'healthfitnessoffers', editId);
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'healthfitnessoffers', id));
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'healthfitnessblog', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'healthfitnessblog');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'healthfitnessblog', id));
...
export default HealthfitnesscategoryForm;
