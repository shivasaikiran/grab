...
const HomeandkitchenForm = () => {
  ...
  const fetchAds = async () => {
    try {
      const adsSnapshot = await getDocs(collection(db, 'categories', 'homeandkitchen', 'ads'));
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db, 'categories', 'homeandkitchen', 'blogs');
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'categories', 'homeandkitchen', 'blogs', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'categories', 'homeandkitchen', 'blogs');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'homeandkitchen', 'blogs', id));
  ...
  const handleAdSubmit = async (e) => {
    ...
    try {
      ...
      if (adEditId) {
        const adDocRef = doc(db, 'categories', 'homeandkitchen', 'ads', adEditId);
        await updateDoc(adDocRef, { imageUrl: adImageUrl });
        toast.success('Ad updated successfully!');
      } else {
        const adsCollectionRef = collection(db, 'categories', 'homeandkitchen', 'ads');
  ...
  const handleAdDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'homeandkitchen', 'ads', id));
  ...
  const fetchItems = async () => {
    try {
      let itemsQuery = collection(db, 'categories', 'homeandkitchen', 'items');
  ...
  const fetchBanners = async () => {
    try {
      const bannersSnapshot = await getDocs(collection(db, 'homeandkitchenbanners'));
  ...
  const handleItemSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const itemDocRef = doc(db, 'categories', 'homeandkitchen', 'items', editId);
        await updateDoc(itemDocRef, { discount, description, name, discounttext, imageUrl,link });
        toast.success('Item updated successfully!');
      } else {
        const itemsCollectionRef = collection(db, 'categories', 'homeandkitchen', 'items');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        const bannerDocRef = doc(db, 'homeandkitchenbanners', bannerEditId);
        await updateDoc(bannerDocRef, {imageUrl: bannerImageUrl });
        toast.success('Banner updated successfully!');
      } else {
        const bannersCollectionRef = collection(db, 'homeandkitchenbanners');
  ...
  const handleItemDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'homeandkitchen', 'items', id));
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'homeandkitchenbanners', id));
...
export default HomeandkitchenForm;
