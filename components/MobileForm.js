...
const MobileForm = () => {
  ...
  const fetchAds = async () => {
    try {
      const adsSnapshot = await getDocs(collection(db, 'categories', 'mobile', 'ads'));
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db, 'categories', 'mobile', 'blogs');
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'categories', 'mobile', 'blogs', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'categories', 'mobile', 'blogs');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'mobile', 'blogs', id));
  ...
  const handleAdSubmit = async (e) => {
    ...
    try {
      ...
      if (adEditId) {
        const adDocRef = doc(db, 'categories', 'mobile', 'ads', adEditId);
        await updateDoc(adDocRef, { imageUrl: adImageUrl });
        toast.success('Ad updated successfully!');
      } else {
        const adsCollectionRef = collection(db, 'categories', 'mobile', 'ads');
  ...
  const handleAdDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'mobile', 'ads', id));
  ...
  const fetchItems = async () => {
    try {
      let itemsQuery = collection(db, 'categories', 'mobile', 'items');
  ...
  const fetchBanners = async () => {
    try {
      const bannersSnapshot = await getDocs(collection(db, 'mobilebanners'));
  ...
  const handleItemSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const itemDocRef = doc(db, 'categories', 'mobile', 'items', editId);
        await updateDoc(itemDocRef, { discount, description, name, discounttext, imageUrl,link });
        toast.success('Item updated successfully!');
      } else {
        const itemsCollectionRef = collection(db, 'categories', 'mobile', 'items');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        const bannerDocRef = doc(db, 'mobilebanners', bannerEditId);
        await updateDoc(bannerDocRef, {imageUrl: bannerImageUrl });
        toast.success('Banner updated successfully!');
      } else {
        const bannersCollectionRef = collection(db, 'mobilebanners');
  ...
  const handleItemDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'categories', 'mobile', 'items', id));
  ...
  const handleBannerDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'mobilebanners', id));
