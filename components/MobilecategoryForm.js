...
const MobilecategoryForm = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const blogsRef = collection(db,'mobileblog');
  ...
  const fetchBanners = async () => {
    try {
      const bannersCollectionRef = collection(db, 'mobilebanner');
  ...
  const handleBannerSubmit = async (e) => {
    ...
    try {
      ...
      if (bannerEditId) {
        ...
        const bannerDocRef = doc(db, 'mobilebanner', bannerEditId);
  ...
  const fetchDeals = async () => {
    const dealsCollectionRef = collection(db, 'mobileoffers');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        const dealDocRef = doc(db, 'mobileoffers', editId);
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'mobileoffers', id));
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      if (blogEditId) {
        const blogDocRef = doc(db, 'mobileblog', blogEditId);
        await updateDoc(blogDocRef, { content: blogContent });
        toast.success('Blog updated successfully!');
      } else {
        const blogsCollectionRef = collection(db, 'mobileblog');
  ...
  const handleBlogDelete = async (id) => {
    try {
      await deleteDoc(doc(db, 'mobileblog', id));
