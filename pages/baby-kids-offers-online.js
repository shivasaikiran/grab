...
function Babyandkids() {
  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'babyandkidsbanners'));
  ...
  {banners.map((banner) => (
    <div key={banner.id} className="relative w-full h-full overflow-hidden">
      ...
      />
        ...
        <div className="p-1 hidden  relative mb-1 bg-green-500 lg:mb-0 lg:mr-2 w-full lg:w-[30%] h-[90px] lg:h-[130px] lg:flex lg:flex-col flex-row space-x-10 lg:space-y-2">
          <span className="relative inline-block mb-1 mr-2 lg:mb-2 lg:top-0 top-7 ">
            <h1 className="font-bold text-white text-start lg:text-center lg:text-4xl text-[13px]">Baby & kids </h1>
    ...
    <FaFacebook size={30} className="text-blue-500 transition-transform duration-300 hover:scale-125" />
      ...
      <div className="mb-4 w-[350px] lg:hidden md:hidden">
          <h2 className="text-2xl font-bold text-black sm:text-3xl">
            ...
            Baby & Kids
              <span className="absolute bottom-[-4px] left-0 lg:w-[155px] w-[140px] h-[2px] bg-[#26ca43]"></span>
            </span>
          </h2>
        </div>
      ...
      {ads.map(ad => (
        ...
        {/* Right Section */}
        <div className="w-full px-1 py-2 lg:px-4 md:w-3/4">
      ...
      <div className="justify-center hidden gap-2 px-6 mt-8 mb-10 lg:grid lg:grid-cols-7 lg:gap-4 sm:grid-cols-7">
