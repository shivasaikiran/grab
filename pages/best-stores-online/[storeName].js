<<<<<<< HEAD:pages/Best-stores-online/[storeName].js
  ...
  return (
    <div className='mt-16 lg:mt-[70px]'>
      ...
      <div className="flex flex-col px-6 md:flex-row">
        {/* Left Section */}
        <div className="hidden w-full p-4 bg-green-100 rounded-md md:w-1/4 sm:block">
          <h3 className="text-lg font-bold text-green-500">Trending Stores</h3>
          <div className="max-h-48">
            <div className="mb-4">
              <p className="ml-2">Mobile</p>
              <p className="ml-2">Fashion</p>
...
export default StoreDetail;
>>>>>>> a2dd772aabcbd52ca9d1415e97b34b272102d895:pages/best-stores-online/[storeName].js
