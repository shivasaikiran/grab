  ...
  {banners.map((banner) => (
    <div key={banner.id} className="relative w-full h-full overflow-hidden">
      ...
      />
        ...
        <div className="p-1   relative mb-1 bg-green-500 lg:mb-0 lg:mr-2 w-full lg:w-[30%] h-[90px] lg:h-[130px] flex lg:flex-col flex-row space-x-8 lg:space-y-2">
      ...
      <div className="flex flex-col px-6 md:flex-row">
        ...
        <div className="mb-4">
          ...
          <Link href='/mobile-offers-online'> <p className="ml-2">Mobile </p></Link>
            ...
            <Link href='/footware-offers-online'> <p className="ml-2">Footware </p></Link>
            </div>
            <div>
