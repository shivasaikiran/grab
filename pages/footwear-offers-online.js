...
function Footware() {
  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'footwarebanners'));
  ...
  useEffect(() => {
    const fetchMobileItems = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'categories', 'footware', 'items'));
  ...
  {banners.map((banner) => (
    <div key={banner.id} className="relative w-full h-full overflow-hidden">
      ...
      />
        ...
        <div className="p-1 hidden  relative mb-1 bg-green-500 lg:mb-0 lg:mr-2 w-full lg:w-[30%] h-[90px] lg:h-[130px] lg:flex lg:flex-col flex-row space-x-8 lg:space-y-2">
          <span className="relative inline-block mb-1 mr-2 lg:mb-2 lg:top-0 top-7 ">
            <h1 className="font-bold text-white text-start lg:text-center lg:text-4xl">Footwear  </h1>
            <span className="absolute hidden sm:block bottom-[-4px] left-24 lg:left-28 lg:w-[170px] w-[160px] h-[2px] bg-white"></span>
          </span>
    ...
    <FaFacebook size={30} className="text-blue-500 transition-transform duration-300 hover:scale-125" />
      ...
      <div className="mb-4 w-[350px] lg:hidden md:hidden">
          <h2 className="text-2xl font-bold text-black sm:text-3xl">
            ...
            Footwear
              <span className="absolute bottom-[-4px] left-0 lg:w-[155px] w-[95px] h-[2px] bg-[#26ca43]"></span>
            </span>
          </h2>
        </div>
      ...
      <div className="flex flex-col px-6 md:flex-row">
        ...
        <div className="mb-4">
          ...
          <Link href='/mobile-deals-online'> <p className="ml-2">Mobile </p></Link>
            ...
            <Link href='/footware-deals-online'> <p className="ml-2">Footware </p></Link>
            </div>
            <div>
      ...
      <Link href='/electronics-offers-online'><div className="flex justify-center">
        ...
        <Link href='/health-fitness-offers-online'><div className="flex justify-center">
          <div className="flex items-center justify-center lg:p-2  border rounded-md shadow-md border-gray-300 hover:border-green-500 hover:shadow-green-500 h-[60px] w-[100px] lg:h-[70px] lg:w-[420px]">
          <p className='text-xs font-bold lg:text-base hover:text-green-500'>Health & Fitness</p>
          </div>
        </div></Link>
